...
def compute_patch_entropy_vectorized(image, patch_size=16, num_scales=2, bins=512, pad_value=1e6):
    ...
    imporatance_val = (entropy_map[56]**2).sum()

    return imporatance_val
...
def process_image(image_path, image_size, patch_size, num_scales, no_resize=False):
    ...
    importance_value = compute_patch_entropy_vectorized(img_tensor, patch_size, num_scales)

    return importance_value

# should be called as
# process_image(image_path, 366, 14)