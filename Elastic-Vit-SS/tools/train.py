"""Train an Elastic-ViT segmentor with pip-installed MMSegmentation 1.x.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Elastic-ViT SS")
    ...
    parser.add_argument("--resume", nargs="?", const="auto", help="Resume from a checkpoint path, or 'auto'")
