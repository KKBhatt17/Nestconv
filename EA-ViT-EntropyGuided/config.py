...
def get_args_parser():
    ...
    parser.add_argument('--constraint_init_steps', default=250, type=int)
    parser.add_argument('--warmup_steps', default=50, type=int)
    parser.add_argument('--total_steps', default=1000, type=int)
    parser.add_argument('--accum_iter', default=1, type=int,
                        help='gradient accumulation steps')
    parser.add_argument('--guide_loss_weight', default=20.0, type=float,
                        help='weight for entropy-to-constraint guide loss')

    parser.add_argument('--gen_id', default=300, type=int)

    parser.add_argument('--constraint', default=1.0, type=int)
    parser.add_argument('--constraint_guide_path', default='', type=str,
                        help='CSV with columns EntropyMean and MACs')
    parser.add_argument('--entropy_image_size', default=366, type=int,
                        help='short side used before entropy estimation')
    parser.add_argument('--entropy_patch_size', default=14, type=int,
                        help='patch size used for entropy estimation')
    parser.add_argument('--entropy_num_scales', default=3, type=int,
                        help='number of scales used by entropy estimation')
    parser.add_argument('--entropy_no_resize', action='store_true', default=False,
                        help='skip entropy resize step and use original image size')
    parser.add_argument('--entropy_cache_dir', default='./entropy_cache', type=str,
                        help='cache directory for precomputed entropy means')
