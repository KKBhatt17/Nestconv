"""Elastic ViT backbone for MMDetection dense heads.
...
Outputs four single-stride feature maps resampled to strides {4, 8, 16, 32} for a
standard FPN.
"""
...
class ElasticViTBackbone(BaseModule):
    ...
    def _load_filtered_checkpoint(self, checkpoint_path: str) -> None:
        ...
        # Surface how much of the stage-2 backbone actually mapped in.
        print(
